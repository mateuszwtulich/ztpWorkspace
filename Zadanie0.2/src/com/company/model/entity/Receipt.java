...
public class Receipt implements Serializable {
    ...
    public Receipt(long id, LocalDateTime dateTime, String taxpayerName, String address, String taxpayerID, float commoditiesSum, float taxSum) {
        this.id = id;
        this.dateTime = dateTime;
        this.taxpayerName = taxpayerName;
        this.address = address;
        this.taxpayerID = taxpayerID;
        this.commoditiesSum = commoditiesSum;
        this.taxSum = taxSum;
    }
